 ...
 * @author fnoorala
 */
public class AnnotationCLI1   {
	/**
	 * Logger for this class
	 */
	private static final Logger logger = LoggerFactory
			.getLogger(AnnotationCLI1.class);

	 

	private static final String USAGE = "java -cp $jar " + AnnotationCLI1.class
  ...
  //DatasetCollection.collectDocument(jwpl,"Renault",config);
             DatasetCollection.collectDocument(jwpl,page,config,"annotation");
         }
