 ...
 * @author fnoorala
 */
public class DiscoveryHub_MilnewittenRelatedness extends Relatedness {

    /**
     * Logger for this class
     */
    private static final Logger logger = LoggerFactory
            .getLogger(DiscoveryHub_MilnewittenRelatedness.class);
    ...
    public DiscoveryHub_MilnewittenRelatedness() {

        sm = SpotManager.getStandardSpotCleaner();

        discovery = new DiscoveryHub(params.getSparqlEndPointPath(), 6, 200);
        int cachesize = params.getCacheSize("spotter");
        cache = new LRUCache<String, Set<String>>(cachesize);
    }

    protected DiscoveryHub_MilnewittenRelatedness(Entity x, Entity y) {
        super(x, y);
    ...
    public Relatedness copy() {
        DiscoveryHub_MilnewittenRelatedness rel = new DiscoveryHub_MilnewittenRelatedness(x, y);
        rel.setScore(score);
        return rel;
    }
