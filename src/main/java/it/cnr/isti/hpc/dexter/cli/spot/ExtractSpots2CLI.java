					...
					for (String spot : spots) {
						...
						if (a.isDisambiguation()) {
							...
							spotManager.enrich(l.getDescription(), spots2);
                                                       //<fnoorala>
                                                        Set<String> spots3 = new HashSet<String>();
                                                        //_(homonymie)
                                                        spotManager.enrich(hp.getLabel(-source).replace("_(disambiguation))", ""),spots3);
                                                        
                                                        for(String label:spots3){
                                                            cli.writeLineInOutput(label + "\t" + hp.getId(l.getCleanId())
										+"\t" + hp.getId(l.getCleanId()));
                                                        }
                                                        //</fnoorala>
