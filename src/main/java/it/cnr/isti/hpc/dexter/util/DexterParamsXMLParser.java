...
public class DexterParamsXMLParser {
    ...
    private LabelSimilarities labelsimilarities;
    private ContextSimilarities contextsimilarities;
    ...
    private Ent2VecRepositoy ent2vecRepository;

    public Ent2VecRepositoy getEnt2VecRepositoy() {
        return ent2vecRepository;
    }

    
    public void setEnt2VecRepositoy(Ent2VecRepositoy ent2vecRepository) {
        this.ent2vecRepository = ent2vecRepository;
    }
    ...
    public void setNlpModels(nlpModels nlpmodels) {
    ...
    public LabelSimilarities getLabelSimilarities() {
        return labelsimilarities;
    }

    public void setLabelSimilarities(LabelSimilarities labelsimilarities) {
        this.labelsimilarities = labelsimilarities;
    }

    public ContextSimilarities getConetxSimilarities() {
        return contextsimilarities;
    }

    public void setContextSimilarities(ContextSimilarities contextsimilarities) {
        this.contextsimilarities = contextsimilarities;
    }
    ...
    public static class Ent2VecRepositoy {

        public String dir;
        public String wordModel;
        public String entityModel;
        public String entityFreebaseModel;
        ...
        public void setWordModel(String wordModel) {
        ...
        public void setEnityModel(String entityModel) {
            this.entityModel = entityModel;
        }

        public String getEnityModel() {
            return entityModel;
        }
          public void setEnityFreebaseModel(String entityFreebaseModel) {
            this.entityFreebaseModel = entityFreebaseModel;
        }

        public String getEnityFreebaseModel() {
    ...
    public static class nlpModels {

        List<nlpModel> nlpmodels = new ArrayList<nlpModel>();
        String defaultnlpModel;

        public String getDefaultModel() {
            return defaultnlpModel;
        }

        public void setDefaultModel(String defaultnlpModel) {
            this.defaultnlpModel = defaultnlpModel;
        }
        ...
        public void setModels(List<nlpModel> nlpmodels) {
            this.nlpmodels = nlpmodels;
        }
    ...
    //<fnoorala>
    public static class LabelSimilarities {

        String defaultFunction;
        List<LabelSimilarity> labelsimilarities = new ArrayList<LabelSimilarity>();
        ...
        public List<LabelSimilarity> getLabelSimilarities() {
            return labelsimilarities;
        }

        public void setLabelSimilarity(
                List<LabelSimilarity> labelSimilarities) {
            this.labelsimilarities = labelSimilarities;
        }

    }

    public static class LabelSimilarity {
    ...
    public static class ContextSimilarities {

        String defaultFunction;
        List<ContextSimilarity> contextsimilarities = new ArrayList<ContextSimilarity>();
        ...
        public List<ContextSimilarity> getContextSimilarities() {
            return contextsimilarities;
        }

        public void setContextSimilarity(
                List<ContextSimilarity> contextsimilarities) {
            this.contextsimilarities = contextsimilarities;
        }

    }

    public static class ContextSimilarity {
    ...
    public static class Similarities {
        ...
        public String getDefaultSimilairty() {
    ...
    public static class Similarity {
        ...
        String name;
        String labelsimilarity;
        String contextsimilarity;
        String ent2vecsimilarity;
        ...
        public String getLableSimilarity() {
            return labelsimilarity;
        }

        public void setLabelSimilarity(String labelsimilarity) {
            this.labelsimilarity = labelsimilarity;
        }

        public String getContectSimilarity() {
            return contextsimilarity;
        }

        public void setContextSimilarity(String contextsimilarity) {
            this.contextsimilarity = contextsimilarity;
        }

        public String getEnt2VecSimilarity() {
            return ent2vecsimilarity;
        }

        public void setEnt2VecSimilarity(String ent2vecsimilarity) {
            this.ent2vecsimilarity = ent2vecsimilarity;
        }
    ...
    public static DexterParamsXMLParser load(String xmlConfig) {
        ...
        xstream.alias("nlpmodel", nlpModel.class);
        ...
        xstream.addImplicitCollection(nlpModels.class, "nlpmodels");
        xstream.aliasField("default", nlpModels.class, "defaultnlpModel");
        ...
        //<fnoorala>
        xstream.addImplicitCollection(LabelSimilarities.class,
                "labelsimilarities");
        xstream.aliasField("default", LabelSimilarities.class,
                "defaultFunction");
        xstream.alias("labelsimilarities", LabelSimilarities.class);
        xstream.alias("labelsimilarity", LabelSimilarity.class);

        xstream.addImplicitCollection(ContextSimilarities.class,
                "contextsimilarities");
        xstream.aliasField("default", ContextSimilarities.class,
                "defaultFunction");
        xstream.alias("contextsimilarities", ContextSimilarities.class);
        xstream.alias("contextsimilarity", ContextSimilarity.class);
        ...
        xstream.aliasField("class", ContextSimilarity.class, "clazz");
        xstream.aliasField("class", LabelSimilarity.class, "clazz");

        xstream.aliasField("default", Similarities.class, "defaultSimilarity");
        xstream.alias("similarities", Similarities.class);
        xstream.addImplicitCollection(Similarities.class, "similarities");
        xstream.alias("similarity", Similarity.class);

        xstream.alias("ent2vecRepository", Ent2VecRepositoy.class);
        xstream.alias("ftpserver", ftpServer.class);
        //</fnoorala>
