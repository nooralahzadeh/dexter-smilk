...
import it.cnr.isti.hpc.dexter.util.Serializer;
		...
		//		.getAbsolutePath());
             ...
             if(params.getAccessMode().equalsIgnoreCase("ftp")){
                    ...
                    try {
                        ...
                        java.util.logging.Logger.getLogger(SpotEliasFanoOffsets.class.getName()).log(Level.SEVERE, null, ex);
                    }  
                        String filePath=StringUtils.difference(params.getftpServerInfo(), offsetsBinFile.getPath());
                       
                   
             ef = (EliasFanoMonotoneLongBigList) serializer.load(filePath,ftpClient);
