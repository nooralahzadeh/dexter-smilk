...
public class Spot implements Serializable {
	...
	protected static int collectionSize;
        ...
        // the part of speach tags  of the mention
...
//                this.pos=Collections.emptyList();
	}

//        public Spot(String mention,List<String> pos) {
//		this.mention = mention;
//                this.pos=pos;
//		this.entities = Collections.emptyList();
//	}
...
//        public Spot(String spot,List<String> pos, List<Entity> entities, int link, int freq) {
//		
//                this.mention = spot;
//		this.freq = freq;
//		this.link = link;
